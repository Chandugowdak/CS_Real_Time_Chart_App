import { THEMES } from "../constants"; //WE ARE IPORTING THE THEMES FROM THE CONSTANTS FOLDER
    ...
    <div className="container h-screen max-w-5xl px-4 pt-20 mx-auto">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 gap-2 sm:grid-cols-6 md:grid-cols-8">
          {/* WE ARE MAPING THE THEME DATA AND WE ARE PLACING THE THEME BASED ON THE USER NEED */}
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
